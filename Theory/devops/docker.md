...
- reason have it -> provide stable endpoints to ReplicaSets or Deployments as follow:
  ![Kubernetes service providing stable endpoint to clients](../image/kubernets_service.png)

# Context-based routing

- The prefered and most scalable way is use an `IngressController`
  ![Context base routing using Kubernetes ingress controller](../image/kubernetes_context_base_routing.png)
