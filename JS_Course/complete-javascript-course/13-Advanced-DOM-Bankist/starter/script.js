...
const arrowMove = function(currSlide,direction){
  const directionMove = direction =='left'?-1:1
  console.log(directionMove);
  slides.forEach((slide,i) =>{
    slide.style.transform = `translateX(${100*(i - currSlide - directionMove)}%)`;
 })
}
